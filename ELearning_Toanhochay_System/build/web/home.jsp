                ...
                <div class="content-wrapper">
                    <aside class="sidebar">
                        <div class="course-category">
                             <h3><i class="fa-solid fa-star"></i> Khoá học miễn phí</h3>
                            <ul class="course-list">
                                <li><a href="#">Ứng Dụng Đạo Hàm...</a></li>
                                <li><a href="#">Nguyên hàm - Tích phân</a></li>
                                <li><a href="#">Phương pháp tọa độ Oxyz</a></li>
                            </ul>
                        </div>
                        <div class="course-category">
                            <h3><i class="fa-solid fa-layer-group"></i> Khoá học cơ bản - nâng cao</h3>
                            <ul class="course-list">
                                <li><a href="#">Thống kê & Xác suất</a></li>
                                <li><a href="#">Mặt nón - Trụ - Cầu</a></li>
                                <li><a href="#">Xem thêm...</a></li>
                            </ul>
                        </div>
                        <div class="course-category">
                            <h3><i class="fa-solid fa-graduation-cap"></i> Khoá học chuyên sâu</h3>
                            <ul class="course-list">
                                 <li><a href="#">Chuyên đề Hàm số</a></li>
                                 <li><a href="#">Chuyên đề Lượng giác</a></li>
                                 <li><a href="#">Xem thêm...</a></li>
                            </ul>
                        </div>
                    </aside>
             ...
             <section class="value-propositions">
                 <div class="container">
                    <div class="header-content">
                        <h2>Giá trị cho Mọi nhà</h2>
                        <p>Giải pháp học Toán toàn diện, hiện đại và hiệu quả.</p>
                    </div>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-logo">
                    ...
                    <img src="https://via.placeholder.com/150x50/0D6EFD/FFFFFF?text=ToanHocHay" alt="ToanHocHay Logo">
